...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      <h1 className="font-display text-4xl font-semibold">About <span className="font-pixel">tech//site</span></h1>
      <p className="mt-2 font-tagline text-xl italic text-muted">Practical answers, not filler.</p>
      <div className="prose-tech mt-6">
        <p>
          <span className="font-pixel text-[1.15em]">tech//site</span> is a premium technology publication covering AI, programming, gadgets, gaming, careers,
