...
export const NICHES: Niche[] = [
  ...
  },
  {
    ...
    label: 'Windows & Linux',
    tagline: 'Faster PCs',
    description: 'Windows optimization, troubleshooting, and power-user tricks.',
    color: '#06B6D4',
  },
  {
    slug: 'buying-guides',
    label: 'Tech Buying Guides',
    tagline: 'Buy smart, not expensive',
  ...
  },
  {
    slug: 'finance',
    label: 'Finance',
    tagline: 'Money moves that matter',
