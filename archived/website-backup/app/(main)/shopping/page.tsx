...
import { Sparkles, ArrowRight, Loader2, Star, Check, Zap, Target, RotateCcw, ExternalLink } from 'lucide-react';
...
const SUGGESTIONS = [
  { label: 'Best camera phone under 30k', icon: '📸' },
  { label: 'Laptop for coding under 60k', icon: '💻' },
  { label: 'Noise cancelling headphones', icon: '🎧' },
  { label: 'Gaming monitor under 25k', icon: '🖥️' },
  { label: 'Smartwatch for fitness', icon: '⌚' },
  { label: 'Mechanical keyboard for typing', icon: '⌨️' },
  { label: 'Wireless earbuds for gym', icon: '🏋️' },
  { label: 'Student laptop under 40k', icon: '🎓' },
];
