 ...
 *
 * The inline script below applies the persisted theme (or OS preference on
 * first visit) before first paint, so the ThemeToggle never flashes.
 */
const THEME_INIT_SCRIPT = `(function(){try{var t=localStorage.getItem('techsite-theme');if(t==='dark'||(!t&&window.matchMedia('(prefers-color-scheme: dark)').matches)){document.documentElement.classList.add('dark')}}catch(e){}})();`;
